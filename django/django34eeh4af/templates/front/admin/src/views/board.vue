<template>
	<div class="content" :style='{"alignContent":"flex-start","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231223/2592f2b1d33d45d299f892501055ed24.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		...
		<div :style='{"width":"100%","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20231223/3329204d7f474f8598c2b6cf87835385.gif) no-repeat center top / 100% 100%","height":"80px"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0 0 0 0","color":"#fff","textAlign":"center","width":"100%","lineHeight":"80px","fontSize":"22px","height":"80px"}'>welcome to use {{this.$project.projectName}}</div>
			<!-- 时间 -->
				...
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>
					...
					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>Total commodity information</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{shangpinxinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>merchandise news</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="biaoti" label="title"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="fengmian" label="cover">
						...
						<el-table-column :resizable="true" :sortable="false" prop="jiage" label="price"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pingjunfen" label="average score"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="haopingdu" label="degree of praise"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="zhongpingdu" label="poisoning severity score"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="chapingdu" label="roundness error evaluation"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
...
export default {
  ...
  methods:{
    ...
    getTimeStrToDay(game_over_timestamp) {
        ...
        return date.getFullYear() + "year" + (date.getMonth() + 1) + "month" + date.getDate() + 'month' + ' ' + ' ' + 'week' + d  + ' ' + "  " + hours + ":" + minutes + ":" + seconds
    },
	times() {
		setInterval(()=>{
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				titleObj.text = 'commodity prices'
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				titleObj.text = 'Average score of goods'
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
				let titleObj = this.line2?this.line2.title:this.line.title
				titleObj.text = 'degree of praise'
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				titleObj.text = 'poisoning severity score'
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
				let titleObj = this.bar.title
				titleObj.text = 'roundness error evaluation'

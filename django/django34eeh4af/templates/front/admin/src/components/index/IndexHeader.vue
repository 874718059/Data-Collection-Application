<template>
	<div class="navbar">
		...
		<div class="right" :style='{"position":"absolute","right":"20px","top":"8px","display":"flex"}'>
			...
			<div :style='{"cursor":"pointer","margin":"0 5px","lineHeight":"44px","color":"#666"}' v-if="this.$storage.get('role')=='管理员'" class="logout" @click="toBoard">board</div>
			<div :style='{"cursor":"pointer","margin":"0 5px","lineHeight":"44px","color":"#666"}' class="logout" @click="onLogout">log out</div>
		</div>
		-->
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"fontSize":"inherit","position":"absolute","right":"30px","color":"inherit","display":"inline-block","zIndex":"9999"}'>
		  ...
		  <el-dropdown-menu class="top-el-dropdown-menu" slot="dropdown">
		    <el-dropdown-item class="item1" :command="''">homepage</el-dropdown-item>
		    <el-dropdown-item class="item2" :command="'center'">userinfo</el-dropdown-item>
		    <el-dropdown-item v-if="this.$storage.get('role')=='管理员'" class="item3" :command="'board'">board</el-dropdown-item>
		    <el-dropdown-item class="item4" :command="'logout'">log out</el-dropdown-item>
		  </el-dropdown-menu>
		</el-dropdown>
